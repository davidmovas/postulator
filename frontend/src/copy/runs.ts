export const runs = {
    ...
    regenerateHint: "Write this page again from its first step, in this run, with the template as it is now.",
    ...
    acceptHint: "The findings stay in the report and the page goes on to its next step as it is.",
    ...
    events: {
        ...
        names: {
            ...
            "item.needs_human": "Item paused",
            "item.restarted": "Item regenerated from the start",
    ...
    start: {
        ...
        picked: (pages: number, parents: number) =>
            `${pages === 1 ? "1 page" : `${pages} pages`}${parents === 0 ? "" : ` · ${parents === 1 ? "1 parent" : `${parents} parents`} written first`}`,
        noPages: "Select at least one page.",
        search: "Find a page",
        searchHint: "Path or title",
        scope: "Which pages",
        scopes: { all: "All", missing: "Not on the site", present: "On the site" },
        noMatch: "No page matches.",
        unmapped: "Nothing is mapped to this page; map it on the Graph screen first.",
        required: (neededBy: string) => `Written first: ${neededBy} needs it on the site.`,
        writtenFirst: "written first",
        branch: "Select the whole branch",
        expand: "Expand",
        collapse: "Collapse",
        addedTitle: "Written first, because a chosen page sits under them",
        added: (path: string, neededBy: string) => `${path} for ${neededBy}`,
        ...
        blocked: "Settle what blocks the run before starting it.",
        findingAt: (path: string, message: string) => `${path}: ${message}`,
