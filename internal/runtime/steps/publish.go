...
func applySEO(ctx context.Context, client *wp.Client, sc *run.StepContext, wpID int64) (applied, skipped []string, err error) {
...
func noSEO() (applied, skipped []string, err error) {
	return []string{}, []string{CodeSEOMetaSkipped}, nil
}
