...
func TestTheShippedStepsRegisterInRecipeOrder(t *testing.T) {
	...
	want := []string{
		...
		steps.NameRepairLinks, steps.NameGenerateImages, steps.NameValidate, steps.NameJudge, steps.NamePublish, steps.NameRelinkNeighbors, steps.NameSyncBack, steps.NameReport,
	}
