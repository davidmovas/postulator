...
type runsStartArgs struct {
	...
	Kind        string   `json:"kind,omitempty" enum:"generate,relink,audit,sync,import,repair,custom" description:"What the run is for; leave it out and the steps decide"`
