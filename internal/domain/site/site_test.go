...
func TestNormalizeBaseURL(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "http on localhost needs no consent", raw: "http://localhost:8089", want: "http://localhost:8089"},
		{name: "http on the loopback address needs no consent", raw: "http://127.0.0.1:8089/wp", want: "http://127.0.0.1:8089/wp"},
		{name: "http on a private address needs no consent", raw: "http://192.168.1.10", want: "http://192.168.1.10"},
		{name: "http on an mdns name needs no consent", raw: "http://shop.local", want: "http://shop.local"},
